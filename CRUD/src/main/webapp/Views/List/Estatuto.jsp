<%-- 
    Document   : estatuto
    Created on : Nov 5, 2021, 8:57:18 PM
    Author     : jared
--%>

<%@page import="Modelo.Estatuto"%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Estatuto">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Estatuto">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Estatuto> resultados = (ArrayList<Estatuto>) request.getSession().getAttribute("resultado");
                                for (Estatuto estatuto : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= estatuto.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="hidden" name="codigo" value="<%= estatuto.getCodigo()%>"></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= estatuto.getNombre()%>" required></th>
                                    <th><input class="btn btn-primary form-control" type="submit" name="accion" value="Editar Estatuto"></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
