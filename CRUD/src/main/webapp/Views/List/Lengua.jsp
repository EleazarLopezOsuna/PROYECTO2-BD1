<%-- 
    Document   : lengua
    Created on : Nov 5, 2021, 8:57:37 PM
    Author     : jared
--%>

<%@page import="Modelo.Lengua"%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Lengua">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Lengua">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Lengua> resultados = (ArrayList<Lengua>) request.getSession().getAttribute("resultado");
                                for (Lengua lengua : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= lengua.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="hidden" name="codigo" value="<%= lengua.getCodigo()%>"></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= lengua.getNombre()%>" required></th>
                                    <th><input class="btn btn-primary form-control" type="submit" name="accion" value="Editar Lengua"></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
