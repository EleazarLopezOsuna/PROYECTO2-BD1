<%-- 
    Document   : horario
    Created on : Nov 5, 2021, 8:57:31 PM
    Author     : jared
--%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Horario">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Horario">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Horario> resultados = (ArrayList<Horario>) request.getSession().getAttribute("resultado");
                                for (Horario horario : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= horario.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="hidden" name="codigo" value="<%= horario.getCodigo()%>"></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= horario.getNombre()%>" required></th>
                                    <th><input class="btn btn-primary form-control" type="submit" name="accion" value="Editar Horario"></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
