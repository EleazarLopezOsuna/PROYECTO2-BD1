<%-- 
    Document   : municipio
    Created on : Nov 5, 2021, 8:57:59 PM
    Author     : jared
--%>
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Municipio> resultados = (ArrayList<Municipio>) request.getSession().getAttribute("resultado");
                                for (Municipio municipio : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= municipio.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= municipio.getDepartamento()%>" disabled></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= municipio.getNombre()%>" disabled></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
