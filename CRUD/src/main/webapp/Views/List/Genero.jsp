<%-- 
    Document   : genero
    Created on : Nov 5, 2021, 8:57:25 PM
    Author     : jared
--%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Genero">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Genero">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Genero> resultados = (ArrayList<Genero>) request.getSession().getAttribute("resultado");
                                for (Genero genero : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
