<%-- 
    Document   : role
    Created on : Nov 5, 2021, 8:58:12 PM
    Author     : jared
--%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Role">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Role">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Role> resultados = (ArrayList<Role>) request.getSession().getAttribute("resultado");
                                for (Role role : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= role.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="hidden" name="codigo" value="<%= role.getCodigo()%>"></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= role.getNombre()%>" required></th>
                                    <th><input class="btn btn-primary form-control" type="submit" name="accion" value="Editar Role"></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
