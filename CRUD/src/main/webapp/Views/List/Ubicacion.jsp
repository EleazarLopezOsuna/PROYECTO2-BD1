<%-- 
    Document   : ubicacion
    Created on : Nov 5, 2021, 8:58:29 PM
    Author     : jared
--%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Ubicacion">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Ubicacion">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Ubicacion> resultados = (ArrayList<Ubicacion>) request.getSession().getAttribute("resultado");
                                for (Ubicacion ubicacion : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= ubicacion.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="hidden" name="codigo" value="<%= ubicacion.getCodigo()%>"></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= ubicacion.getNombre()%>" required></th>
                                    <th><input class="btn btn-primary form-control" type="submit" name="accion" value="Editar Ubicacion"></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
