<%-- 
    Document   : nivel
    Created on : Nov 5, 2021, 8:58:08 PM
    Author     : jared
--%>
            ...
            <div class="row">
                <div class="col-sm">
                    <form action="Controller">
                        <input class="form-control" type="text" name="nombre" value="" required placeholder="Nombre Nivel">
                        <input class="btn btn-primary form-control" type="submit" name="accion" value="Agregar Nivel">
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                ArrayList<Nivel> resultados = (ArrayList<Nivel>) request.getSession().getAttribute("resultado");
                                for (Nivel nivel : resultados) {
                            %>
                            <form action="Controller">
                                <tr>
                                    <th><input class="form-control" type="text" value="<%= nivel.getCodigo()%>" disabled></th>
                                    <th><input class="form-control" type="hidden" name="codigo" value="<%= nivel.getCodigo()%>"></th>
                                    <th><input class="form-control" type="text" name="nombre" value="<%= nivel.getNombre()%>" required></th>
                                    <th><input class="btn btn-primary form-control" type="submit" name="accion" value="Editar Nivel"></th>
                                </tr>
                            </form>
                            <%}%>
                        </tbody>
